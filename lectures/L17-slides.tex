...
We can therefore create 10~000/50 = 200 runs.
...
Or: compute the (regular) join, then do a select on all tuples, keeping those without a match, and pad those tuples and add them to the result.
