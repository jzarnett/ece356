...
\texttt{INSERT INTO owner\_address ( SELECT * FROM employee\_address )}; is a minimal statement that takes the result of the selection and uses it as a set of tuples to insert.
